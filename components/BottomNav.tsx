...
export default function BottomNav({
  ...
  const baseButton =
    'flex flex-col items-center justify-center px-4 py-2 rounded-2xl bg-white/70 backdrop-blur-md border border-white/60 shadow-sm transition-colors';
  const homeClass =
